...
var jstpl_points_card = '<div class="bgabnc_points_card ${small_class}"><div class="bgabnc_points_card_x ${on_class}"></div><div class="bgabnc_points_card_ability">${ability}</div><div class="bgabnc_points_card_letter">${value}</div></div>';
